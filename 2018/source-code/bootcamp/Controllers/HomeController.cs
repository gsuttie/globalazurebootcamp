...
namespace bootcamp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index(string proxyUrl = "https://raw.githubusercontent.com/gsuttie/azurebootcamp-data/master/2020/locations/glasgow/data.json")
        {
