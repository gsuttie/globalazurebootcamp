...
namespace bootcamp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index(string proxyUrl = "https://raw.githubusercontent.com/AndrewLowrie/globalazurebootcamp/master/2018/azurebootcamp-data/2019/locations/glasgow/data.json")
        {
